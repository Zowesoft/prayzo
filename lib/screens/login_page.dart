                        ...
                        children: [
                          Row(
                            ...
                            children: const [
                              ...
                              SizedBox(width: 8),
                              Text('PrayerVerse', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          ...
                          ElevatedButton(
                            onPressed: auth.isLoading
                                ...
                                : () async {
                                    ...
                                    if (_isSignUp) {
                                      final ok = await auth.signUp(email, password, displayName: _nameController.text.trim());
                            ...
                            child: Text(auth.isLoading ? 'Please wait...' : (_isSignUp ? 'Create account' : 'Sign in')),
                          ),
                          TextButton(
                            onPressed: auth.isLoading
                                ? null
